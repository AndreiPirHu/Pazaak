...
export const SingleplayerLoadout = () => {
  ...
  return (
    <div className="SingleplayerLoadout">
      <div className="board">
      ...
      <div className="button-container">
        ...
        {playersReady ? (
          <button onClick={navigateToSingleplayer} className="game-button">
            <span>Start</span>
          </button>
        ) : (
          ""
